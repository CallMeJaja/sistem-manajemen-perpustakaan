...
<div class="card border-0 shadow-sm">
    <div class="card-body">
        <form method="GET" action="{{ route('borrowings.index') }}" class="row g-2 mb-3 align-items-end">
            ...
            <div class="col-md-4">
                <label for="borrowings-search" class="form-label small text-muted mb-0">Cari</label>
                <div class="input-group">
                    <span class="input-group-text bg-white"><i class="bi bi-search text-muted"></i></span>
                    <input type="text" name="search" id="borrowings-search" class="form-control border-start-0"
